...
ssize_t acpuclk_get_vdd_levels_str(char *buf) {
 ...
 for (i = 0; pll0_960_pll1_245_pll2_1200_pll4_1209[i].a11clk_khz; i++) {
 if (pll0_960_pll1_245_pll2_1200_pll4_1209[i].use_for_scaling)
 len += sprintf(buf + len, "%8u: %8d\n", pll0_960_pll1_245_pll2_1200_pll4_1209[i].a11clk_khz, pll0_960_pll1_245_pll2_1200_pll4_1209[i].vdd);
 }
...
void acpuclk_set_vdd(unsigned int khz, int vdd_uv) {
 ...
 for (i = 0; pll0_960_pll1_245_pll2_1200_pll4_1209[i].a11clk_khz; i++) {
 if ( pll0_960_pll1_245_pll2_1200_pll4_1209[i].a11clk_khz == khz)
 pll0_960_pll1_245_pll2_1200_pll4_1209[i].vdd = vdd_uv;
 }
